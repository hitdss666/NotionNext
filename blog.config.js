...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi,我是松临,让我们共同拥抱人工智能与大数据计量经济学的新时代,欢迎您的访问！🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '松临', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '经济学博士', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://forever666.lol', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '数理统计学,计量经济学,计算机,人工智能,学术论文,随笔', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'jardon@163.com', // 邮箱地址 例如mail@tangly1024.com
